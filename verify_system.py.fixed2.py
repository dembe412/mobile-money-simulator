...
main_content = main_py.read_text(encoding="utf-8", errors="ignore") if main_py.exists() else ""
test(
...
ops_content = ops_py.read_text(encoding="utf-8", errors="ignore") if ops_py.exists() else ""
test(
...
hashing_content = hashing_py.read_text(encoding="utf-8", errors="ignore") if hashing_py.exists() else ""
test(
...
ussd_content = ussd_py.read_text(encoding="utf-8", errors="ignore") if ussd_py.exists() else ""
test(
...
client_content = client_lib.read_text(encoding="utf-8", errors="ignore") if client_lib.exists() else ""
test(
...
routes_content = routes_py.read_text(encoding="utf-8", errors="ignore") if routes_py.exists() else ""
test(
...
idempotency_content = idempotency_py.read_text(encoding="utf-8", errors="ignore") if idempotency_py.exists() else ""
test(
...
phone_guide_content = phone_guide.read_text(encoding="utf-8", errors="ignore") if phone_guide.exists() else ""
test(
...
compose_content = compose.read_text(encoding="utf-8", errors="ignore") if compose.exists() else ""
test(
...
settings_content = settings.read_text(encoding="utf-8", errors="ignore") if settings.exists() else ""
test(
